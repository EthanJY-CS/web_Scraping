...
class TestWebScraper(unittest.TestCase):
    ...
    def test_generate_ID(self):
        id = self.mens_Catalogue.generate_ID("https://uk.gymshark.com/products/gymshark-power-t-shirt-black-aw21")
    ...
    def test_create_Directory(self):
        ...
        file = pathlib.Path("raw_data")
        if not file.exists ():
            self.fail("The directory raw_data does not Exist!")

    def test_download_Image(self):
        self.mens_Catalogue.current_Directory = "raw_data/images"
        self.mens_Catalogue.create_Directory()
        ...
        file = pathlib.Path("raw_data/images")
        if not file.exists ():
            self.fail("The directory images does not Exist!")
        else:
            file = pathlib.Path("raw_data/images/0.jpg")
            if not file.exists():
    ...
    def test_create_JSON_file(self):
        ...
        file = pathlib.Path("raw_data/data.json")
        if not file.exists ():
